    ...
    <div className="flex items-end gap-3">
      <div className={cn(
        ...
        isDark
          ...
          : 'bg-slate-50 border-slate-200 focus-within:border-jyotish-gold/40'
      )}>
        <textarea
          ref={textareaRef}
          value={value}
          ...
          rows={1}
          className={cn(
            'w-full bg-transparent resize-none text-sm outline-none placeholder:opacity-40 max-h-32',
      ...
      <button
        ...
        className={cn(
          ...
          value.trim() && !isLoading
            ? 'bg-jyotish-gold text-black hover:bg-celestial-gold shadow-[0_0_20px_rgba(212,175,55,0.2)]'
