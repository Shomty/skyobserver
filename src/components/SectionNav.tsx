...
export const SectionNav: React.FC<SectionNavProps> = ({ activeTab, setActiveTab }) => {
  ...
  return (
    <nav className={cn(
      "hidden md:flex items-center justify-center gap-2 px-4 md:px-6 py-2.5 border-b backdrop-blur-xl relative z-30 transition-colors duration-500 overflow-x-auto no-scrollbar",
          ...
          <button
            ...
            className={cn(
              ...
              isActive
                ...
                : theme === 'dark' ? "text-white/50 hover:text-white/70" : "text-slate-500 hover:text-slate-700"
            )}
          >
