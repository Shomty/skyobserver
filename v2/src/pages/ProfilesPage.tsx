  ...
  return (
    <div className={cn(
      ...
      <div className={cn(
        ...
        theme === 'dark' ? 'bg-[var(--bg1)] border-[var(--sep)]' : 'bg-white/80 border-slate-200'
      )}>
        <button
          onClick={onClose}
          className={cn(
            'p-2 rounded-xl border transition-colors',
            theme === 'dark' ? 'bg-[var(--bg3)] border-[var(--sep)] text-[var(--text2)] hover:text-[var(--text0)] hover:bg-[var(--bg4)]' : 'bg-white border-slate-200 text-slate-500 hover:text-slate-900 shadow-sm'
          )}
        >
        ...
        <section>
              ...
              <button
                ...
                className={cn(
                  ...
                  childProfiles.length >= MAX_PROFILES
                    ? theme === 'dark' ? 'opacity-30 cursor-not-allowed bg-white/5 border-[var(--sep2)] text-white/40' : 'opacity-30 cursor-not-allowed bg-slate-100 border-slate-200 text-slate-400'
                  ...
                  <div className="space-y-1.5">
                    ...
                    <input
                      ...
                      className={cn(
                        ...
                        theme === 'dark' ? 'bg-[var(--bg3)] border-[var(--sep)] text-[var(--text0)]' : 'bg-slate-50 border-slate-200 text-slate-900'
                      )}
                    />
                  </div>
                  ...
                  <div className="space-y-1.5">
                    ...
                    <input
                      ...
                      className={cn(
                        ...
                        theme === 'dark' ? 'bg-[var(--bg3)] border-[var(--sep)] text-[var(--text0)] [color-scheme:dark]' : 'bg-slate-50 border-slate-200 text-slate-900 [color-scheme:light]'
                      )}
                    />
                  </div>
                        ...
                        {showCitySuggestions && citySuggestions.length > 0 && (
                          <motion.div
                            ...
                            className={cn(
                              ...
                              theme === 'dark' ? 'bg-[var(--bg2)] border-[var(--sep2)]' : 'bg-white/95 border-slate-200'
                            )}
                          >
                            {citySuggestions.map((c, i) => (
                              <button
                                ...
                                className={cn(
                                  ...
                                  theme === 'dark' ? 'hover:bg-[var(--bg4)] text-[var(--text0)]' : 'hover:bg-slate-100 text-slate-700'
                                )}
                              >
                  ...
                  <div className="flex gap-2 pt-2">
                    <button
                      ...
                      className={cn(
                        ...
                        theme === 'dark' ? 'bg-[var(--bg3)] text-[var(--text2)] border-[var(--sep)] hover:bg-[var(--bg4)]' : 'bg-slate-50 text-slate-500 border-slate-200 hover:bg-slate-100'
                      )}
                    >
                      Cancel
                    </button>
          ...
          {childProfiles.length === 0 && !showForm && (
            <div className={cn(
              ...
              theme === 'dark' ? 'border-[var(--sep2)]' : 'border-slate-200'
            )}>
                    ...
                    <div className="flex items-center gap-1.5 shrink-0">
                      ...
                      {!showForm && (
                        <button
                          ...
                          className={cn(
                            'p-2 rounded-xl border transition-colors',
                            theme === 'dark' ? 'bg-white/5 border-[var(--sep2)] text-white/40 hover:text-jyotish-gold hover:bg-jyotish-gold/10 hover:border-jyotish-gold/30' : 'bg-white border-slate-200 text-slate-400 hover:text-[#E8B84B] hover:bg-[rgba(232,184,75,0.08)] shadow-sm'
                          )}
                          title="Edit profile"
                        >
                      ...
                      {deletingId === profile.id ? (
                        <div className="flex items-center gap-1">
                          ...
                          <button
                            ...
                            className={cn(
                              ...
                              theme === 'dark' ? 'bg-[var(--bg3)] text-[var(--text0)]' : 'bg-slate-100 text-slate-600'
                            )}
                          >
                            Cancel
                          </button>
                        ...
                        !showForm && (
                          <button
                            ...
                            className={cn(
                              'p-2 rounded-xl border transition-colors',
                              theme === 'dark' ? 'bg-white/5 border-[var(--sep2)] text-white/40 hover:text-red-400 hover:bg-red-500/10 hover:border-red-500/20' : 'bg-white border-slate-200 text-slate-400 hover:text-red-500 hover:bg-red-50 shadow-sm'
                            )}
