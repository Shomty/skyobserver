  ...
  return (
    <div className={cn(
      ...
      <div className={cn(
        ...
        theme === 'dark' ? "border-[var(--sep2)] bg-[var(--bg1)]" : "border-slate-200 bg-white"
      )}>
          ...
          <div className="relative flex-1">
            ...
            <input 
              ...
              className={cn(
                ...
                theme === 'dark' ? "bg-[var(--bg2)] border-[var(--sep)] text-[var(--text0)]" : "bg-slate-50 border-slate-200 text-slate-800"
              )}
            />
          </div>
            ...
            >
              ...
              <div className="flex-1 overflow-y-auto p-8 lg:p-12 custom-scrollbar">
                <div className="max-w-3xl mx-auto space-y-8">
                  ...
                  <div className="prose prose-invert prose-sm max-w-none prose-headings:text-jyotish-gold prose-p:text-[var(--text1)] prose-strong:text-jyotish-gold prose-ul:text-[var(--text1)]">
                    <ReactMarkdown>{getReportContent(selectedReport.data)}</ReactMarkdown>
                  </div>

                  <div className="pt-12 border-t border-white/5 flex items-center justify-between">
                    <div className="flex items-center gap-4">
                       <button className="flex items-center gap-2 px-4 py-2 rounded-xl bg-white/5 border border-[var(--sep2)] text-[10px] uppercase font-bold tracking-widest hover:bg-white/10 transition-all">
                        Archive Entry
                       </button>
                    </div>
                    <button 
