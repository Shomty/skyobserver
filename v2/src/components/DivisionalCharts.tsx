...
const DivisionalCharts: React.FC<DivisionalChartsProps> = ({
  ...
  const cardBase = cn(
    ...
    isDark ? 'bg-[var(--bg2)] border-[var(--sep)]' : 'bg-white border-slate-100 shadow-sm',
  );
  ...
  return (
    <div className="flex flex-col gap-4">
      ...
      <div className={cardBase}>
        ...
        <select
          ...
          className={cn(
            ...
            isDark
              ? 'bg-[var(--bg2)] border-[var(--sep)] text-[var(--text0)]'
      ...
      {user?.uid && birthFingerprint && (
        <div className={cn('rounded-3xl border', isDark ? 'bg-[var(--bg2)] border-[var(--sep)]' : 'bg-white border-slate-100 shadow-sm')}>
